...
% \textbf{Solution} To do this, we take the norm from the point $Q$ to the point $y = -2$, parameterized by $\mathbf{r}(t) = (t, -2, t)$. The distance is thus $\sqrt{(t - 0)^2 + (-2 - 2)^2 + (t - 0)^2} = \sqrt{2t^2 + 4}$

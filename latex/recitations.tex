...
\subsection{Exercises 309-312}
\includegraphics[scale=0.7]{assets/rec04-ex309-312.png}

\subsection{Example 2.59 Identifying Equations of Quadric Surfaces}
...
\newpage
\section{09-09-2025}
§3.1 Exercises 8, 22; §3.2 Checkpoints 3.5, 3.7, [3.8 opt]

\newpage
\section{09-11-2025}
% Checkpoint 3.9 + write the arc length parametrization by solving for t in terms of s (answer: t = sqrt (s^(2/3) - 32/9)); Checkpoint 3.13; Exercise 3.143.
